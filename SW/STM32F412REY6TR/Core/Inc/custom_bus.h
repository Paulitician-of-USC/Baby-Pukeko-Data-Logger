...
#define BUS_SPI2_SCK_GPIO_PORT GPIOC
#define BUS_SPI2_SCK_GPIO_PIN GPIO_PIN_7
#define BUS_SPI2_SCK_GPIO_AF GPIO_AF5_SPI2
#define BUS_SPI2_SCK_GPIO_CLK_DISABLE() __HAL_RCC_GPIOC_CLK_DISABLE()
#define BUS_SPI2_SCK_GPIO_CLK_ENABLE() __HAL_RCC_GPIOC_CLK_ENABLE()
